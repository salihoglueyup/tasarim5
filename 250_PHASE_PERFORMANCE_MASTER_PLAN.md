...
- [ ] **Faz 119:** Sayfa içi tüm animasyonlu GIF'leri sessiz döngülü WebM/MP4 formatına dönüştürme.
- [ ] **Faz 120:** `loading="lazy"` ve `decoding="async"` niteliklerinin below-the-fold tüm görsellerde yer almasını sağlama.
