...
```
docs/
├── dev/            → Geliştirici kılavuzları (kurulum, deploy, katkı)
...
| Vercel'e deploy etmek istiyorum | [dev/DEPLOYMENT.md](dev/DEPLOYMENT.md) |
...
| 250 Fazlık optimizasyon planı | [dev/OPTIMIZATION_PLAN.md](dev/OPTIMIZATION_PLAN.md) |
