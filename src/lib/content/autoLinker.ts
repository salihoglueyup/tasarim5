...
const CUSTOM_LINKS: { term: string; href: string }[] = [
  ...
  // Site Yönetimi Temel Anahtar Kelimeleri & Varyasyonları (Site Yönetimi Hub'ına Silo Ayrımı)
  { term: 'profesyonel site yönetimi', href: '/hizmetler/site-yonetimi' },
  { term: 'site yönetim şirketi istanbul', href: '/hizmetler/site-yonetimi' },
  { term: 'site yönetim şirketleri', href: '/hizmetler/site-yonetimi' },
  { term: 'site yönetim şirketi', href: '/hizmetler/site-yonetimi' },
  { term: 'site yönetim firmaları', href: '/hizmetler/site-yonetimi' },
  { term: 'apartman ve site yönetimi', href: '/hizmetler/site-yonetimi' },
  { term: 'apartman yöneticiliği', href: '/hizmetler/site-yonetimi' },
  { term: 'site yöneticiliği', href: '/hizmetler/site-yonetimi' },
  { term: 'site yönetimi', href: '/hizmetler/site-yonetimi' },
  { term: 'apartman yönetimi', href: '/hizmetler/site-yonetimi' },
