...
export function buildFacilityVoiceKnowledge(lang: string = 'tr', filterIntent?: string): VoiceKnowledgeGraph {
  ...
  const trQuestions: VoiceSearchQAItem[] = [
    ...
    {
      id: 'site-yonetimi-nedir-ve-neleri-kapsar',
      queryIntent: 'informational',
      voiceQuery: 'Site yönetimi nedir ve neleri kapsar?',
      speakableAnswer: 'Site yönetimi, 634 sayılı Kat Mülkiyeti Kanunu kapsamında çok bağımsız bölümlü konut sitelerinin aidat tahsilatı, 5188 güvenlik, temizlik, teknik bakım ve genel kurul divan süreçlerini tek elden yürüten organizasyondur.',
      detailedExplanation: 'Alo Yönetim, 150+ aktif site portföyünde Apsiyon mobil entegrasyonu, şeffaf dijital bütçeleme, 45 dakika acil teknik müdahale ve yüzde 99.2 aidat tahsilat başarısıyla hizmet verir.',
      legalReference: '634 Sayılı KMK Madde 34-40',
      targetKeyword: 'site yönetimi nedir neleri kapsar',
    },
    {
      id: 'site-yonetim-sirketi-nasil-secilir',
      queryIntent: 'commercial',
      voiceQuery: 'Site yönetim şirketi nasıl seçilir?',
      speakableAnswer: 'Site yönetim şirketi seçerken 5188 lisanslı güvenlik belgesi, ISO 41001 ve TSE HYB kalite sertifikaları, şeffaf mobil yazılım ve en az 45 dakikalık acil teknik servis taahhüdü aranmalıdır.',
      detailedExplanation: 'Alo Yönetim, kurumsal SLA sözleşmeleri, bağımsız denetim raporları ve Apsiyon altyapısı ile kat maliklerine yüzde yüz şeffaf ve denetlenebilir yönetim sunar.',
      legalReference: 'TSE HYB 12850 & KMK 34',
      targetKeyword: 'site yönetim şirketi nasıl seçilir',
    },
    {
      id: 'apartman-yoneticisi-nasil-secilir',
      queryIntent: 'legal',
      voiceQuery: 'Apartman yöneticisi nasıl seçilir?',
      speakableAnswer: 'Kat Mülkiyeti Kanunu Madde 34 uyarınca yönetici, kat malikleri kurulunda hem sayı hem de arsa payı çoğunluğuyla seçilir.',
      detailedExplanation: 'Ana gayrimenkulde sekiz veya daha fazla bağımsız bölüm varsa yönetici atanması zorunludur. Malikler anlaşamazsa sulh hukuk mahkemesi resen yönetici atayabilir.',
      legalReference: '634 Sayılı KMK Madde 34',
      targetKeyword: 'apartman yöneticisi nasıl seçilir',
    },
    {
      id: 'aidat-odenmezse-icra-takibi-sureci',
      queryIntent: 'legal',
      voiceQuery: 'Site aidatı ödenmezse icra takibi nasıl yapılır?',
      speakableAnswer: 'Kesinleşen işletme projesine istinaden ödenmeyen aidatlar için İcra İflas Kanunu 68 kapsamında doğrudan ilamsız icra takibi başlatılır ve aylık yüzde 5 gecikme tazminatı işletilir.',
      detailedExplanation: 'Alo Yönetim hukuk müşavirliği, vadesi geçen aidat borçlarını noter ihtarnamesine gerek kalmaksızın UYAP üzerinden hızlı icra takibine dönüştürerek sitenin nakit akışını korur.',
      legalReference: 'KMK Madde 20 & İİK Madde 68',
      targetKeyword: 'ödenmeyen aidat icra takibi',
    },
    {
      id: 'apartman-genel-kurul-cogunluk-sarti',
      queryIntent: 'legal',
    ...
    {
      id: 'sitelerde-denetcinin-gorevleri-nelerdir',
      queryIntent: 'informational',
      voiceQuery: 'Site yönetiminde denetçinin görevleri nelerdir?',
      speakableAnswer: 'Denetçi veya denetim kurulu en az üç ayda bir hesapları denetler, haklı bir sebep çıktığında her zaman inceleme yapabilir ve genel kurula yıllık denetim raporu sunar.',
      detailedExplanation: 'KMK Madde 41 uyarınca denetçi, yöneticinin gelir-gider makbuzlarını, banka hesap hareketlerini ve işletme projesi harcamalarını kontrol ederek maliklerin haklarını güvence altına alır.',
      legalReference: '634 Sayılı KMK Madde 41',
      targetKeyword: 'site denetçisi görevleri',
    },
    {
      id: 'sitelerde-elektrikli-arac-sarj-istasyonu-izni',
      queryIntent: 'legal',
      voiceQuery: 'Kapalı otoparkta elektrikli araç şarj istasyonu kurmak için izin gerekir mi?',
      speakableAnswer: 'Ortak alana şarj istasyonu kurulumu için KMK Madde 42 uyarınca kat malikleri kurulunun sayı ve arsa payı çoğunluğu kararı zorunludur.',
      detailedExplanation: 'Bağımsız bölüme ait müstakil sayaçtan hat çekilmesinde yangın ve statik güvenlik şartlarına uyulması gerekir. Alo Yönetim teknik ekipleri mühendislik onaylı altyapı projeleri hazırlar.',
      legalReference: '634 Sayılı KMK Madde 42',
      targetKeyword: 'kapalı otopark elektrikli araç şarj istasyonu izni',
    },
    {
      id: 'site-yonetim-sirketi-fiyatlari-nasil-belirlenir',
      queryIntent: 'commercial',
      voiceQuery: 'Site yönetim şirketlerinin hizmet fiyatları nasıl belirlenir?',
      speakableAnswer: 'Site yönetim ücretleri genellikle bağımsız bölüm sayısı, tesisin büyüklüğü, havuz, peyzaj ve asansör gibi ortak alanların durumuna göre daire başına aylık olarak belirlenir.',
      detailedExplanation: 'Alo Yönetim, şeffaf fiyatlandırma politikasıyla daire başı makul sabit yönetim bedeli uygular ve toplu satın alma gücüyle sitenin toplam genel bütçesinde yüzde 30 net tasarruf sağlar.',
      legalReference: 'Hizmet Sözleşmesi & SLA Standartları',
