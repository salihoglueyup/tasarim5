import { buildFacilityCompleteGraphSchema, FACILITY_COMPLETE_GRAPH_CREDENTIALS } from '@/lib/seo/facility/facilityCompleteGraphBuilder';
import { generateFacilityMeshLinks, getAdjacentDistricts } from '@/lib/seo/facility/facilityMeshLinkerEngine';
import { buildFacilityVoiceKnowledge } from '@/lib/seo/facility/facilityVoiceKnowledgeEngine';
import { lintSchemaGraph } from '@/lib/seo/audits/schemaLinter';
import { DISTRICTS } from '@/data/districts';
import { OFFICIAL_LEGAL_CITATIONS } from '@/lib/seo/facility/facilityExternalCitations';
