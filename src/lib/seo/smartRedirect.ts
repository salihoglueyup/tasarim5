...
export const STATIC_ROUTE_SYNONYMS: Record<string, string> = {
  ...
  // GSC Bozuk Slug ve Eski URL 301 Eşleştirmeleri (Faz 253)
  'bolgeler/-mraniye': '/bolgeler/umraniye',
  'bolgeler/ata-ehir': '/bolgeler/atasehir',
  'bolgeler/-i-li': '/bolgeler/sisli',
  'bolgeler/kad-k-y': '/bolgeler/kadikoy',
  'bolgeler/ba-ak-ehir': '/bolgeler/basaksehir',
  'bolgeler/beylikd-z-': '/bolgeler/beylikduzu',
  'bolgeler/sar-yer': '/bolgeler/sariyer',
  'bolgeler/-atalca': '/bolgeler/catalca',
  'bolgeler/-ekmek-y': '/bolgeler/cekmekoy',
  'bolgeler/bak-rk-y': '/bolgeler/bakirkoy',
  'bolgeler/basaksehir/mahalleler/sahıntepe': '/bolgeler/basaksehir/mahalleler/sahintepe',
  'bolgeler/esenyurt/mahalleler/mehterçesme': '/bolgeler/esenyurt/mahalleler/mehtercesme',
  'bolgeler/sariyer/mahalleler/yenıkoy': '/bolgeler/sariyer/mahalleler/yenikoy',
  'sozluk/i-lamsiz-i-cra-takibi-aidat-borcu': '/sozluk/ilamsiz-icra-takibi-aidat-borcu',
  'hizmetler/aidat-ve-butce-yonetimi': '/hizmetler/aidat-takibi',
  'hizmetler/havuz-bakim': '/hizmetler/havuz-bakimi-ve-hijyen',
  'hizmetler/ozel-guvenlik': '/hizmetler/guvenlik-yonetimi',
  'hizmetler/hasere-kontrol': '/hizmetler/hasere-ve-dezenfeksiyon',
  'kurumsal': '/hakkimizda',
  'kurumsal/hakkimizda': '/hakkimizda',
  'kurumsal/sertifikalar': '/kurumsal/kalite-belgelerimiz',
  'sektorel-cozumler/toplukonut': '/hizmetler/tesis-yonetimi/toplu-konut-yonetimi',
  'sektorel-cozumler/avm': '/hizmetler/tesis-yonetimi/plaza-yonetimi',
  'sektorel-cozumler/sanayi': '/hizmetler/tesis-yonetimi/sanayi-tesisi-yonetimi',
  'sektorel-cozumler/rezidans': '/hizmetler/tesis-yonetimi/rezidans-site-yonetimi',
  'sektorel-cozumler/site-ve-toplu-konut-yonetimi': '/hizmetler/tesis-yonetimi/toplu-konut-yonetimi',
  '45/deneme-haber-3': '/blog',
  '45/deneme-haber-3.html': '/blog',
};
