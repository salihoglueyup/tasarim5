...
export const SERVICES: ServiceDef[] = [
  {
    ...
    keywords: [
      ...
      'tesis yönetimi fiyatları',
      'tesis yönetimi teklif al',
      'site yönetimi',
    ...
    longTailKeywords: [
      ...
      'ataşehir rezidans ve tesis yönetim şirketleri',
      'büyük ölçekli toplu konut ve sanayi tesisi yönetimi',
      'tesis yönetim şirketi seçiminde dikkat edilecek kriterler',
      'apartman ve site yöneticisi nasıl seçilir kmk',
    ],
    kmkArticles: [
    ...
    faqSnippets: [
      ...
      },
      {
        ...
        a: 'Klasik site yönetimi temel aidat ve kapıcı hizmetlerine odaklanırken; entegre tesis yönetimi mühendislik tabanlı kestirimci bakım, 7/24 merkezi otomasyon (HVAC, jeneratör), yasal iş güvenliği (İSG), şeffaf dijital denetim ve kurumsal SLA garantileri sunar.',
      },
      {
        q: 'Tesis yönetim şirketi aidat ve işletme maliyetlerini nasıl düşürür?',
        a: 'Toplu satın alma gücü, önleyici teknik mühendislik bakımı, reaktif ceza önleyici kompanzasyon takibi ve enerji optimizasyonu ile işletme bütçelerinde %20 ile %30 arasında net tasarruf sağlar.',
      },
      {
