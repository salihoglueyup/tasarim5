...
const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { nameKey: 'dist_kadikoy', path: '/bolgeler/kadikoy/tesis-yonetimi', descKey: 'dist_kadikoy_desc', icon: 'location_on' },
      { nameKey: 'dist_atasehir', path: '/bolgeler/atasehir/tesis-yonetimi', descKey: 'dist_atasehir_desc', icon: 'location_on' },
      { nameKey: 'dist_besiktas', path: '/bolgeler/besiktas/tesis-yonetimi', descKey: 'dist_besiktas_desc', icon: 'location_on' },
      { nameKey: 'dist_sisli', path: '/bolgeler/sisli/tesis-yonetimi', descKey: 'dist_sisli_desc', icon: 'location_on' },
      { nameKey: 'dist_uskudar', path: '/bolgeler/uskudar/tesis-yonetimi', descKey: 'dist_uskudar_desc', icon: 'location_on' },
      { nameKey: 'dist_maltepe', path: '/bolgeler/maltepe/tesis-yonetimi', descKey: 'dist_maltepe_desc', icon: 'location_on' },
      { nameKey: 'dist_basaksehir', path: '/bolgeler/basaksehir/tesis-yonetimi', descKey: 'dist_basaksehir_desc', icon: 'location_on' },
      { nameKey: 'dist_sariyer', path: '/bolgeler/sariyer/tesis-yonetimi', descKey: 'dist_sariyer_desc', icon: 'location_on' },
      { nameKey: 'dist_umraniye', path: '/bolgeler/umraniye/tesis-yonetimi', descKey: 'dist_umraniye_desc', icon: 'location_on' },
      { nameKey: 'dist_kartal', path: '/bolgeler/kartal/tesis-yonetimi', descKey: 'dist_kartal_desc', icon: 'location_on' },
      { nameKey: 'dist_bakirkoy', path: '/bolgeler/bakirkoy/tesis-yonetimi', descKey: 'dist_bakirkoy_desc', icon: 'location_on' },
      { nameKey: 'dist_beylikduzu', path: '/bolgeler/beylikduzu/tesis-yonetimi', descKey: 'dist_beylikduzu_desc', icon: 'location_on' },
    ]
  },
  {
