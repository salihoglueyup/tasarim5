...
export default function SpotlightSearchModal() {
  ...
  const filteredResults = useMemo(() => {
    if (!query.trim()) {
      return searchableItems.slice(0, 8); // Boşken en popüler ilk 8 öneri
    }
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-start justify-center pt-16 sm:pt-24 px-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col z-10"
          >
            {/* Search Input Bar */}
