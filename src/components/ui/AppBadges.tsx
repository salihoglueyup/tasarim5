...
export default function AppBadges() {
  // Ortak tasarım sınıfları: Hafif gradient, iç gölge ve hover efektleri
  const badgeClasses = "flex items-center justify-center gap-3 w-full sm:w-auto bg-gradient-to-b from-[#1a1a1a] to-black border border-gray-800/80 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] px-4 py-2 rounded-xl hover:from-[#252525] hover:to-[#0a0a0a] transition-all hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] group";
  ...
  return (
    <div className="flex flex-col sm:flex-row flex-wrap items-center gap-3 pt-2">
      ...
      <button
        ...
        className={badgeClasses}
      >
        <svg viewBox="0 0 24 24" fill="#CF0A2C" className="w-7 h-7">
