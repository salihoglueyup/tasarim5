    ...
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4 sm:p-6 md:p-12 font-sans">
      ...
      >
        ...
        <div className="flex-1 flex flex-col relative bg-white dark:bg-[#0b1c30] w-full h-full overflow-y-auto custom-scrollbar">
          ...
          <div className="flex-1 flex flex-col justify-center p-6 md:p-10 lg:p-16">
            ...
            {!isCompleted ? (
              <div className="w-full max-w-xl mx-auto flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-2 mt-8 lg:mt-0">
                  <div className="flex items-center justify-between text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-4">
                    ...
                    <span className="text-blue-600 text-right">{steps[currentStep].title}</span>
                  </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-5">
                          <div className="group">
                            ...
                            <input 
                              ...
                              className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all font-medium placeholder-gray-400 dark:placeholder-gray-600"
                      ...
                      {currentStep === 1 && (
                        <div className="flex flex-col gap-8">
                                ...
                                <button
                                  ...
                                  className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl border-2 transition-all ${
                                    formData.projectType === pt.id 
                                      ? 'border-blue-600 bg-blue-50 dark:bg-blue-600/10 text-blue-700 dark:text-blue-400 shadow-sm scale-[1.02]' 
                          ...
                          <div className="flex flex-col gap-5 bg-gray-50 dark:bg-white/5 p-6 rounded-2xl border border-gray-200 dark:border-white/10">
                            <div className="flex justify-between items-end">
                              ...
                              <span className="text-2xl font-black text-blue-600">{formData.unitCount}</span>
                            </div>
                            <input 
                              type="range" 
                              min="10" 
                      ...
                      {currentStep === 2 && (
                        <div className="flex flex-col gap-4">
                          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium -mt-2">{t('quote_step_3_desc')}</p>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {[
                              ...
                              return (
                                ...
                                >
                                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center shrink-0 ${isSelected ? `bg-${srv.color}-500 text-white` : 'bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-gray-400'}`}>
                                    <span className="material-symbols-outlined text-[20px]">{srv.icon}</span>
                                  </div>
                                  <span className={`font-bold text-xs ${isSelected ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-300'}`}>
                                    {srv.label}
                                  </span>
                                  {isSelected && (
                                    <span className={`material-symbols-outlined ml-auto text-[18px] text-${srv.color}-500`}>check_circle</span>
                                  )}
                                </button>
                              );
                            })}
                        ...
                        <div className="flex flex-col gap-6">
                          <div className="group">
                            ...
                            <textarea 
                              ...
                              className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3.5 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all font-medium text-sm resize-none"
                              placeholder="..."
                            />
                          </div>

                          <label className="flex items-start gap-4 cursor-pointer group bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800/30 hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
                            <div className="relative flex items-center justify-center mt-0.5 shrink-0">
                              ...
                              />
                              <div className="w-5 h-5 border-2 border-blue-400 rounded-md peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors flex items-center justify-center">
                                <span className="material-symbols-outlined text-white text-[12px] opacity-0 peer-checked:opacity-100 scale-50 peer-checked:scale-100 transition-all">check</span>
                              </div>
                            </div>
                            <span className="text-xs font-medium text-blue-900 dark:text-blue-200 leading-relaxed">
                              {t('quote_step_4_kvkk')}
                            </span>
                          </label>
                        </div>
                ...
                {/* Navigation Buttons */}
                <div className="flex items-center justify-between pt-6 mt-auto border-t border-gray-100 dark:border-white/10">
                  <button 
                    onClick={handlePrev}
                  ...
                  <button 
                    ...
                    className="bg-blue-600 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-lg shadow-blue-600/30 hover:bg-blue-500 hover:scale-105 hover:shadow-blue-600/50 disabled:opacity-50 disabled:hover:scale-100 disabled:shadow-none disabled:cursor-not-allowed transition-all flex items-center gap-2"
                  >
              ...
              >
                <div className="w-20 h-20 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 rounded-full flex items-center justify-center mb-6 shadow-xl shadow-emerald-500/10">
                  <span className="material-symbols-outlined text-4xl">task_alt</span>
                </div>
                <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-4 tracking-tight">
                  {t('quote_success_title')}
                </h1>
                <p className="text-base text-gray-600 dark:text-gray-400 font-light leading-relaxed mb-10">
                  {t('quote_success_desc')}
                </p>
                <button 
                  onClick={onClose}
                  className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-8 py-3.5 rounded-xl font-bold text-sm shadow-xl hover:scale-105 transition-all flex items-center gap-2"
                >
