...
export default function PoolCalculator() {
  ...
  // Fake logic: Pool maintenance = 20 TL per m3 (chemicals) + 15000 base cost (operator & tests)
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <label className="text-sm font-bold text-[var(--color-primary)]">{t('calc_pool_volume')}</label>
              ...
              <input 
                ...
                value={poolVolume}
                onChange={(e) => { setPoolVolume(parseInt(e.target.value)); setIsCalculated(true); }}
