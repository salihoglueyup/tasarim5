    ...
    <>
      ...
      <div className="relative w-full min-h-[85vh] flex flex-col justify-center overflow-hidden bg-slate-950">
        <div className="absolute inset-0 z-0">
          ...
          <Image src="https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=2000&auto=format&fit=crop" alt="hukuk-ve-icra-danismanligi hero" fill className="object-cover object-center opacity-30" priority />
        </div>
