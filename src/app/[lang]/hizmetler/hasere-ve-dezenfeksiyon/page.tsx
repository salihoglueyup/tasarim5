...
export default function HasereVeDezenfeksiyon() {
  ...
  const pestPoints = [
    {
      title: t('pest_feat_1_title'),
      desc: t('pest_feat_1_desc'),
      icon: "verified"
    },
    {
      title: t('pest_feat_2_title'),
      desc: t('pest_feat_2_desc'),
      icon: "bug_report"
    },
    {
      title: t('pest_feat_3_title'),
      desc: t('pest_feat_3_desc'),
      icon: "cleaning"
    },
    {
      title: t('pest_feat_4_title'),
      desc: t('pest_feat_4_desc'),
      icon: "description"
    }
  ];
  ...
  return (
    <>
      <JsonLd data={[breadcrumbLd, serviceLd, faqLd, webPageSchema({ path: '/hizmetler/hasere-ve-dezenfeksiyon', speakableSelectors: ['h1', '#speakable-content'] })]} />
      ...
      <section className="py-24 px-[var(--spacing-gutter)] max-w-[var(--spacing-container-max)] mx-auto space-y-20">
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-outline)]/60 p-10 md:p-14 rounded-[3rem] shadow-sm">
          <h2 className="text-3xl font-bold text-[var(--color-primary)] mb-8">{t('pest_faq_title')}</h2>
