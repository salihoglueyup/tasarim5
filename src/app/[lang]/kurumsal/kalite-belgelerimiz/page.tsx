...
export async function generateMetadata({
  ...
  const description = 'ISO 41001:2018 Tesis Yönetimi, ISO 9001, ISO 14001, ISO 45001 ve 5188 lisanslı kalite ve güvenlik akreditasyonlarımız. Kurumsal belgelerimizi inceleyin.';
