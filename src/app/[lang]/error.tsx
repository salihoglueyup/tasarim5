    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 dark:bg-[#071322] px-6">
      <div className="max-w-2xl text-center flex flex-col items-center">
        <motion.div 
          ...
          className="text-8xl md:text-9xl font-extrabold text-red-500 opacity-90 mb-4"
        >
          500
        </motion.div>
        ...
        >
          <button 
            onClick={() => reset()}
            className="bg-[var(--color-primary)] hover:bg-[var(--color-primary)]/90 text-white font-semibold py-3 px-8 rounded-full transition-colors flex items-center justify-center gap-2 cursor-pointer"
          >
