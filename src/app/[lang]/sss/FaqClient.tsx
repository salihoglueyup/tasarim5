  ...
  return (
    <>
      ...
      <div className="relative mb-12 max-w-2xl mx-auto">
        ...
        <input 
          type="text" 
          placeholder="Sorunuzu arayın (Örn: Aidat, İcra, Asansör)..."
          value={searchQuery}
      ...
      <div className="flex flex-col gap-4">
        {filteredFaqs.length === 0 ? (
          <div className="text-center py-12 text-slate-500">
            ...
            <p className="text-lg">Aradığınız kritere uygun soru bulunamadı.</p>
          </div>
        ) : (
      ...
      <div className="mt-20 bg-gradient-to-br from-slate-900 to-slate-800 dark:from-brand-950 dark:to-slate-900 text-white p-10 md:p-14 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          <h3 className="text-2xl md:text-3xl font-bold mb-3">Aradığınız cevabı bulamadınız mı?</h3>
          <p className="text-slate-300 font-light text-lg max-w-xl">
            Uzman ekibimize hemen ulaşın, size özel çözümler sunalım veya ücretsiz keşif hizmetimizden yararlanın.
          </p>
        </div>
        <Link 
          href="/iletisim" 
